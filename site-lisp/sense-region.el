...
;;; $Id: sense-region.el,v 1.1.1.1 2002/08/25 14:24:48 komatsu Exp $
;;;
...
(defun sense-region-get-regexp-selection-list (regexp &optional
  ...
  (save-excursion
    ...
    (let (selection-alist)
      (goto-char (min start end))
      (save-match-data
	(while (re-search-forward regexp (max start end) t)
	  (setq selection-alist 
